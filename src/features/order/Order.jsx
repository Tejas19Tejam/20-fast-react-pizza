...
// Loader Function || Get data of particular order

// params - Route params are parsed from dynamic segments(If a path segment starts with : then it becomes a "dynamic segment".) and passed to your loader.
// The params object contains the dynamic parameters from the route path
